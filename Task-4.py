...
rock_b = Button(root, text='Rock', width=8, command=lambda: game(1))
rock_b.place(x=33, y=505)

# Button for selecting paper
paper_b = Button(root, text='Paper', width=7, command=lambda: game(2))
paper_b.place(x=128, y=505)

# Button for selecting scissor
scissor_b = Button(root, text='Scissor', width=7, command=lambda: game(3))
scissor_b.place(x=225, y=505)
